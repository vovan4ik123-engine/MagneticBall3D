...
namespace MagneticBall3D
{
    Improvements::Improvements()
    {
        std::vector<ImprovementInfo> imprInfoVector{{ImprovementType::PLAYER_MAX_SPEED,                 5, {{[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.08f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 0."); }},
                                                    ...
                                                    {ImprovementType::PLAYER_BETTER_CLUTCH_WITH_WALLS,    5, {{[&]() { EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.1f;  BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 0."); }},
                                                                                                                              {[&]() { EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.1f; BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 1."); }},
                                                                                                                              {[&]() { EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.1f;  BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 2."); }},
                                                                                                                              {[&]() { EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.1f; BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 3."); }},
                                                                                                                              {[&]() { EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.1f;  BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 4."); }}}},
                                                    {ImprovementType::PLAYER_MAGNETIZE_MORE_GARBAGE, 5, {{[&]() { EnAndVars::playerMagneticRadius += 5.0f;
                                                                                                                                            ...
                                                                                                                                            EnAndVars::playerTorqueFactorOnBuildingWall += EnAndVars::playerTorqueFactorOnBuildingWallDefault * 0.05f;
