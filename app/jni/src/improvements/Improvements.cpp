...
namespace MagneticBall3D
{
    Improvements::Improvements()
    {
        std::vector<ImprovementInfo> imprInfoVector{{ImprovementType::PLAYER_MAX_SPEED,                 m_maxLevel, {{[&]() { EnumsAndVars::playerMaxSpeedXZ += EnumsAndVars::playerMaxSpeedXZDefault * 0.08f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 0."); }},
                                                    ...
                                                    {ImprovementType::JUMPPAD_POWER,                    m_maxLevel, {{[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.15f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 0."); }},
                                                                                                                             {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.15f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 1."); }},
                                                                                                                             {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.15f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 2."); }},
                                                                                                                             {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.15f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 3."); }},
                                                                                                                             {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.15f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 4."); }}}}
                                                    };
