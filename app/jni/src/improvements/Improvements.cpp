...
namespace MagneticBall3D
{
    ...
    {
        std::vector<ImprovementInfo> imprInfoVector{{ImprovementType::PLAYER_MAX_SPEED,                 5, {{[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.1f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 0."); }},
                                                                                                                            {[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.1f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 1."); }},
                                                                                                                            {[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.1f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 2."); }},
                                                                                                                            {[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.1f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 3."); }},
                                                                                                                            {[&]() { EnAndVars::playerMaxSpeedXZ += EnAndVars::playerMaxSpeedXZDefault * 0.1f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 4."); }}}},
