...
namespace MagneticBall3D
{
    ...
    {
        std::vector<ImprovementInfo> imprInfos;
        imprInfos.reserve(20);
        if(EnumsAndVars::MapsProgress::currentMapIndex == 0)
        {
            imprInfos.push_back({ImprovementType::PLAYER_MAX_SPEED,        m_maxLevel, {{[&]() { EnumsAndVars::playerMaxSpeedXZ += EnumsAndVars::playerMaxSpeedXZDefault * 0.08f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_ACCELERATE_FASTER,m_maxLevel,  {{[&]() { EnumsAndVars::playerImpulseFactorOnGround += EnumsAndVars::playerImpulseFactorOnGroundDefault * 0.04f;
            ...
            imprInfos.push_back({ImprovementType::PLAYER_SHOOT_FASTER,      m_maxLevel, {{[&]() { EnumsAndVars::damageShotReloadTime -= EnumsAndVars::damageShotReloadTimeDefault * 0.12f; BR_INFO("%s", "Block PLAYER_SHOOT_FASTER pressed 0."); }},
                                                                                                           {[&]() { EnumsAndVars::damageShotReloadTime -= EnumsAndVars::damageShotReloadTimeDefault * 0.12f; BR_INFO("%s", "Block PLAYER_SHOOT_FASTER pressed 1."); }},
                                                                                                           {[&]() { EnumsAndVars::damageShotReloadTime -= EnumsAndVars::damageShotReloadTimeDefault * 0.12f; BR_INFO("%s", "Block PLAYER_SHOOT_FASTER pressed 2."); }},
                                                                                                           {[&]() { EnumsAndVars::damageShotReloadTime -= EnumsAndVars::damageShotReloadTimeDefault * 0.12f; BR_INFO("%s", "Block PLAYER_SHOOT_FASTER pressed 3."); }},
                                                                                                           {[&]() { EnumsAndVars::damageShotReloadTime -= EnumsAndVars::damageShotReloadTimeDefault * 0.12f; BR_INFO("%s", "Block PLAYER_SHOOT_FASTER pressed 4."); }}}});
        }
        else
        {
            imprInfos.push_back({ImprovementType::PLAYER_MAX_SPEED,                 m_maxLevel, {{[&]() { EnumsAndVars::playerMaxSpeedXZ += EnumsAndVars::playerMaxSpeedXZDefault * 0.08f; BR_INFO("%s", "Block PLAYER_MAX_SPEED pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_PUSH_ENEMIES_BETTER,       m_maxLevel, {{[&]() { EnumsAndVars::playerSpeedReductionMultiplier -= 0.08f; BR_INFO("%s", "Block PLAYER_PUSH_ENEMIES_BETTER pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_BETTER_CLUTCH_WITH_WALLS,  m_maxLevel, {{[&]() { EnumsAndVars::playerTorqueFactorOnBuildingWall += EnumsAndVars::playerTorqueFactorOnBuildingWallDefault * 0.2f; BR_INFO("%s", "Block PLAYER_BETTER_CLUTCH_WITH_WALLS pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_MAGNETIZE_MORE_GARBAGE,    m_maxLevel, {{[&]() { EnumsAndVars::playerMagneticRadius += 4.0f;
            ...
            imprInfos.push_back({ImprovementType::PLAYER_INCREASE_MAX_HP,           m_maxLevel, {{[&]() { m_player->addToMaxHP(EnumsAndVars::playerStartHP * 0.1f); BR_INFO("%s", "Block PLAYER_INCREASE_MAX_HP pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_TAKE_LESS_DAMAGE,          m_maxLevel, {{[&]() { EnumsAndVars::playerDamageTakenMultiplier -= 0.08f; BR_INFO("%s", "Block PLAYER_TAKE_LESS_DAMAGE pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_EXP_GAIN,                  m_maxLevel, {{[&]() { EnumsAndVars::playerXPMultiplier += EnumsAndVars::playerXPMultiplierDefault * 0.08f; BR_INFO("%s", "Block PLAYER_EXP_GAIN pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::PLAYER_DAMAGE_GROUND_AFTER_FALL,  m_maxLevel, {{[&]() { EnumsAndVars::playerDamageGroundRadiusAfterFall += 25.0f; BR_INFO("%s", "Block PLAYER_DAMAGE_GROUND_AFTER_FALL pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::GARBAGE_SPAWN_MORE_ON_MAP,        m_maxLevel, {{[&]() { EnumsAndVars::garbageCommonMaxCountOnMap += 12; BR_INFO("%s", "Block GARBAGE_SPAWN_MORE_ON_MAP pressed 0."); }},
                                                                                                                   {[&]() { EnumsAndVars::garbageCommonMaxCountOnMap += 12; BR_INFO("%s", "Block GARBAGE_SPAWN_MORE_ON_MAP pressed 1."); }},
                                                                                                                   {[&]() { EnumsAndVars::garbageCommonMaxCountOnMap += 12; BR_INFO("%s", "Block GARBAGE_SPAWN_MORE_ON_MAP pressed 2."); }},
                                                                                                                   {[&]() { EnumsAndVars::garbageCommonMaxCountOnMap += 12; BR_INFO("%s", "Block GARBAGE_SPAWN_MORE_ON_MAP pressed 3."); }},
                                                                                                                   {[&]() { EnumsAndVars::garbageCommonMaxCountOnMap += 12; BR_INFO("%s", "Block GARBAGE_SPAWN_MORE_ON_MAP pressed 4."); }}}});

            imprInfos.push_back({ImprovementType::GARBAGE_TAKE_LESS_DAMAGE,         m_maxLevel, {{[&]() { EnumsAndVars::garbageDamageTakenMultiplier -= 0.08f; BR_INFO("%s", "Block GARBAGE_TAKE_LESS_DAMAGE pressed 0."); }},
            ...
            imprInfos.push_back({ImprovementType::JUMPPAD_POWER,                    m_maxLevel, {{[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.12f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 0."); }},
                                                                                                                   {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.12f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 1."); }},
                                                                                                                   {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.12f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 2."); }},
                                                                                                                   {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.12f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 3."); }},
                                                                                                                   {[&]() { EnumsAndVars::jumpPadPower += EnumsAndVars::jumpPadPowerDefault * 0.12f; BR_INFO("%s", "Block JUMPPAD_POWER pressed 4."); }}}});
        }
        
        for(const ImprovementInfo& info : imprInfos)
        {
            ...
            else if(info.type == ImprovementType::PLAYER_SHOOT_FASTER)
            {
                mainTexturePath = "GUI/improvements/PLAYER_SHOOT_FASTER.jpg";
                selectedTexturePath = "GUI/improvements/PLAYER_SHOOT_FASTER_SELECTED.jpg";
                BR_INFO("%s", "Created GUI block for PLAYER_SHOOT_FASTER.");
            }
            ...
            {
                BR_ASSERT(false, "%s", "Unknown improvement type.");
            }
