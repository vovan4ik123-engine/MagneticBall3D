...
namespace MagneticBall3D
{
    ...
    void Map2::draw()
    {
        ...
        if(BaseEnemy::getActiveCount() < 250)
...
//        }
    ...
    void Map2::spawnEnemies()
    {
        ...
        else if(m_prepareWave2 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave2Time)
        {
            ...
            BR_INFO("Prepare wave 2. Max enemies: %d", ratCount);
        }
        else if(m_prepareWave3 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave3Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(gunCount < 20 && enemy->unitType == UnitType::ENEMY_GUN1)
                {
                    enemy->isCanBeSpawned = true;
                    ++gunCount;
                }
            ...
            BR_INFO("Prepare wave 3. Max enemies: %d", ratCount + gunCount);
        }
        else if(m_prepareWave4 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave4Time)
        {
            ...
            BR_INFO("Prepare wave 4. Max enemies: %d", ratCount + gunCount + gunShieldCount);
        }
        else if(m_prepareWave5 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave5Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(gunCount < 40 && enemy->unitType == UnitType::ENEMY_GUN1)
                {
                    enemy->isCanBeSpawned = true;
                    ++gunCount;
                }
            ...
            BR_INFO("Prepare wave 5. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount);
        }
        else if(m_prepareWave6 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave6Time)
        {
            ...
            BR_INFO("Prepare wave 6. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount);
        }
        else if(m_prepareWave7 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave7Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(rocketCount < 4 && enemy->unitType == UnitType::ENEMY_TANK)
                {
                    enemy->isCanBeSpawned = true;
                    ++rocketCount;
                }
            ...
            BR_INFO("Prepare wave 7. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount + rocketCount);
        }
        else if(m_prepareWave8 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave8Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(rocketCount < 6 && enemy->unitType == UnitType::ENEMY_TANK)
                {
                    enemy->isCanBeSpawned = true;
                    ++rocketCount;
                }
            ...
            BR_INFO("Prepare wave 8. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount + rocketCount);
        }
        else if(m_prepareWave9 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave9Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(gunCount < 80 && enemy->unitType == UnitType::ENEMY_GUN1)
                {
                    enemy->isCanBeSpawned = true;
                    ++gunCount;
                }
                ...
                else if(rocketCount < 8 && enemy->unitType == UnitType::ENEMY_TANK)
                {
                    enemy->isCanBeSpawned = true;
                    ++rocketCount;
                }
            ...
            BR_INFO("Prepare wave 9. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount + rocketCount);
        }
        else if(m_prepareWave10 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave10Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(gunCount < 90 && enemy->unitType == UnitType::ENEMY_GUN1)
                {
                    enemy->isCanBeSpawned = true;
                    ++gunCount;
                }
                ...
                else if(rocketCount < 10 && enemy->unitType == UnitType::ENEMY_TANK)
                {
                    enemy->isCanBeSpawned = true;
                    ++rocketCount;
                }
            ...
            BR_INFO("Prepare wave 10. Max enemies: %d", ratCount + gunCount + gunShieldCount + sniperCount + rocketCount);
        }
        else if(m_prepareWave11 && EnumsAndVars::mapPlayTimeSec > m_enemiesWave11Time)
        {
            ...
            for(auto& enemy : m_allAnimatedEnemies)
            {
                ...
                else if(rocketCount < 15 && enemy->unitType == UnitType::ENEMY_TANK)
                {
                    enemy->isCanBeSpawned = true;
                    ++rocketCount;
                }
        ...
        if(!m_pointsToSpawnEnemies.empty())
        {
            for(const auto& enemy : m_allAnimatedEnemies)
            {
                        ...
                        StaticEnemy::spawnTime + StaticEnemy::spawnDelay < EnumsAndVars::mapPlayTimeSec)
                {
                    ...
                    {
                        // Check position in free + not closest than 100m.
                        if(sniperPos.isFreePosition &&
                           glm::distance(m_player->getObj()->getOrigin(), sniperPos.position) > 100.0f)
                        {
