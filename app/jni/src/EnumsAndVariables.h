...
namespace EnumsAndVariables
{
    ...
    // Player.
    inline float playerMagneticRadius = 15.0f;
    inline float playerImpulseFactorOnGround = 0.12f;
    inline float playerTorqueFactorOnGround = 0.1f;
    inline float playerImpulseFactorOnBuilding = 0.1f;
    inline float playerTorqueFactorOnBuilding = 0.1f; // Will multiplied by radius.
    ...
    inline int garbageCommonSpawnCount = 4.0f; // Sec.
